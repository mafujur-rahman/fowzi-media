  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img
          ref={image1Ref}
          src="/assets/img/development/DAISANE/uiux mockup/COVER-2.jpg"
          alt="Project 1"
        ...
        >
          <h2 className="text-xl mb-16">OCT 2024 - DEVELOPMENT</h2>
          <p className="text-6xl font-bold mb-10">Abdi <br /> Daisane</p>
          <button className="hover:bg-white border border-gray-400 hover:text-black py-2 px-6 rounded-2xl  transition duration-300">
            <Link target="_blank" href={'https://daisaneformn.com/'}>SEE PROJECT</Link>
          </button>
...
export default LatestProjects3;