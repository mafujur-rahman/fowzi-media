        ...
        <div className="container mx-auto">
            <div className="my-8">
                <h2 ref={textRef} className="font-bold text-5xl md:text-7xl lg:text-8xl overflow-hidden mt-4">
                    <span className="inline-block reveal-text mr-3">Optimal Home HealthCare</span>
                </h2>
            </div>
            ...
            <div className="w-full max-w-7xl mx-auto h-[500px] relative overflow-hidden">
                ...
                >
                    <Image
                        src="/assets/img/branding/optimal/branding mockup/business card mockup/business card@2x.png"
                        alt="about-img-1"
            ...
            <div className="my-20">
                ...
                <div className="grid grid-cols-1 place-items-center w-full">
                    ...
                    <div className="mt-8 grid grid-cols-4 gap-10 text-center">
                        <p className="w-50 h-50 px-10 py-20 text-white rounded-3xl border-0 bg-[#073f37]">#073f37</p>
                        <p className="w-50 h-50 px-10 py-20 text-white rounded-3xl border-0 bg-[#0d5d54]">#0C0C0C</p>
            ...
            <div className="mt-16 ">
                ...
                <div className="grid grid-cols-2 gap-8">
                    <img className="row-span-1 w-full h-[450px] object-cover rounded-2xl"
                        src="/assets/img/branding/optimal/branding mockup/letter envelope mockup/envelope.png"
                        alt=""
                    />
                    <img className="row-span-2 w-full h-[720px] object-cover rounded-2xl"
                        src="/assets/img/branding/optimal/branding mockup/flyer mockup/flyer@2x.png"
                        alt=""
                    />
                    <img className="row-span-2 w-full h-[720px] object-cover rounded-2xl"
                        src="/assets/img/branding/optimal/branding mockup/stationary mockup/branding-3@2x@2x@2x@2x.png"
                        alt=""
                    />
                    <img className="row-span-1 w-full h-[450px] object-cover rounded-2xl"
                        src="/assets/img/branding/optimal/branding mockup/business card mockup/business card@2x.png"
